!(function (a, i) {
    ...
    function d(a, i) {
        for (var e, r; (r = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
            (e = new b(new Date(a.at + r))).offset === a.offset
                ? (a = e)
                : (i = e)
        return a
    }
    ...
    function C(a) {
        ...
        return (
            r && !A.isMoment(a) && k(o) && o.add(r.parse(o), 'minutes'),
            o.tz(e),
            o
        )
    }
    ;(e < 2 || (2 === e && r < 6)) &&
            ...
            parse: function (a) {
                ...
                for (o = 0; o < t; o++)
                    if (
                        ...
                        (e = c[o + 1]),
                        (r = c[o ? o - 1 : o]),
                        i < e && C.moveAmbiguousForward
                            ? (i = e)
                            : r < i && C.moveInvalidForward && (i = r),
                        A < n[o] - 6e4 * i)
                    )
                        return c[o]
                return c[t]
        ...
        (M.prototype.scoreOffsetAt = function (a) {
            ;(this.offsetScore += Math.abs(
                this.zone.utcOffset(a.at) - a.offset
            )),
