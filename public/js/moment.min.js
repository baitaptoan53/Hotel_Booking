!(function (e, a) {
        ...
        if (e._f !== l.ISO_8601)
            if (e._f !== l.RFC_2822) {
                ...
                var a,
                    ...
                    u = 0
                for (
                    s = G(e._f, e._locale).match(z) || [], a = 0;
                    a < s.length;
                    a++
                )
                    (n = s[a]),
    ...
    function za(e, a) {
        ...
        return a._isUTC
            ? ((t = a.clone()),
              (s =
                  (D(e) || u(e) ? e.valueOf() : Sa(e).valueOf()) - t.valueOf()),
    ...
    ;(it.add = $a),
        ...
        (it.diff = function (e, a, t) {
            ...
            switch (
                ((n = 6e4 * (s.utcOffset() - this.utcOffset())), (a = O(a)))
            ) {
                case 'year':
                    d = Ba(this, s) / 12
                    break
    ...
    l.defineLocale('ky', {
        ...
        l.defineLocale('lb', {
            ...
            relativeTime: {
                future: function (e) {
                    return en(e.substr(0, e.indexOf(' ')))
                        ? 'a ' + e
                        : 'an ' + e
                },
                past: function (e) {
    ...
    var Jn =
        ...
        Nn = 'jan_feb_mar_apr_m\xe1j_j\xfan_j\xfal_aug_sep_okt_nov_dec'.split(
            '_'
        )
    function Rn(e) {
        return 1 < e && e < 5
