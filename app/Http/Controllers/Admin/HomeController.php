...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.home.index', compact('users', 'calc_users',
         'users_last_month', 'room_booking',
          'calc_room_booking', 'room_booking_last_month'
          , 'total_price', 'calc_total_price', 'total_price_last_month'
          , 'total_room', 'calc_total_room', 'total_room_last_month'));
    }
}
